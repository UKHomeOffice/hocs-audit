...
public class AuditRepositoryTest {
    ...
    private LinkedHashSet<AuditData> getCaseDataAuditData() {
        ...
        return new LinkedHashSet<AuditData>(){{
            ...
            add(new AuditData(UUID.fromString("3e5cf44f-e86a-4b21-891a-018e2343cda1"),UUID.randomUUID(),UUID.randomUUID().toString(),"a-service", "{\"type\": \"MIN\", \"uuid\": \"3e5cf44f-e86a-4b21-891a-018e2343cda1\"}", "an-env", LocalDateTime.parse("2019-04-23 15:20:16", dateFormatter), "CASE_COMPLETED", UUID.randomUUID().toString()));
            add(deleted);
        }};
    }
