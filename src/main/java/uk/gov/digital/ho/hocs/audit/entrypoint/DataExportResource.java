...
public class DataExportResource {
    ...
    void getDataExport(@RequestParam("fromDate") LocalDate fromDate,
        ...
        try {
            ...
            if (service == null) {
                throw new InvalidExportTypeException("Export service does not exist for type: %s", LogEvent.INVALID_EXPORT_TYPE, exportType);
            }
    ...
    //TODO: can HttpServletResponse be swapped to StreamingResponseBody?
